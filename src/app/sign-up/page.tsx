...
export default function SignUpPage() {
  ...
  const handleSelectGoogleAccount = async (gName: string, gEmail: string) => {
    setIsSubmitting(true);
    await signInWithGoogle(gName, gEmail);
    router.push("/");
  };
  ...
  return (
    <>
      ...
      <div className="flex-1 flex items-center justify-center p-6 min-h-[calc(100vh-4rem)] bg-[#0a0a0a] text-neutral-100 font-sans">
